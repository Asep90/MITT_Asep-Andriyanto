...
<tr>
    <td width='200'>NO  </td>
	<td>$sql[no]<input type='hidden' name='no' value='$sql[no]'/></td>
</tr>
<tr>
    <td width='200'>NIK  </td>
	<td><input type='text' name='txt_nik' value='$sql[nik]'/></td>
</tr>

<tr>
    <td width='200'>NAMA KARYAWAN </td>
    <td><input type='text' name='txt_nama' required='required' value='$sql[nama_karyawan]' /></td>
</tr>
<tr>
    <td width='200'>TANGGAL LAHIR</td>
    <td><input type='text' name='txt_tgl' required='required' value='$sql[tgl_lahir]' /></td>
</tr>
<tr>
...
<tr>
    <td>NO TLP</td>
    <td><input type='text' name='tlp' required='required' value='$sql[no_tlp]' /></td>
</tr>
...
<tr>
    <td>FOTO</td>
    <td><img src='gambar/$sql[foto]' width='150' height='115'/><input type='file' name='foto' /></td>
</tr>";
